...
namespace torneo_calcetto.EF.Migrations
{
    ...
    [Migration("20250520202052_num_part")]
    partial class num_part
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("torneo_calcetto.EF.Models.Torneo", b =>
                {
                    ...
                    b.Property<int>("FkIdUtenteCreatore")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UtenteNavigationIdPk");

                    b.ToTable("Tornei");
                });

            modelBuilder.Entity("torneo_calcetto.EF.Models.Utente", b =>
                {
                    b.Property<int>("IdPk")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("torneo_calcetto.EF.Models.Torneo", b =>
                {
                    b.HasOne("torneo_calcetto.EF.Models.Utente", "UtenteNavigation")
                        .WithMany()
                        .HasForeignKey("UtenteNavigationIdPk")
